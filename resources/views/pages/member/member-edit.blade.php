                ...
                <div class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-full">
                    ...
                    <div class="px-5 py-3 border-b border-slate-200">
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('member.index') }}" class="text-slate-400 hover:text-slate-500" @click="modalOpen = false">
                    ...
                    <form action="{{ route('member.update', $item->id) }}" method="post">
                        ...
                        <div class="px-5 py-4">
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <input id="email" name="email" class="form-input w-full px-2 py-1" type="email" value="{{ $item->email }}" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="phone_number">Nomor HP/WA</label>
                                    <input id="phone_number" name="phone_number" class="form-input w-full px-2 py-1" type="number" value="{{ $item->phone_number }}" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="store_name">Nama Toko</label>
                                    <input id="store_name" name="store_name" class="form-input w-full px-2 py-1" type="text" value="{{ $item->store_name }}" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="location">Asal Kota</label>
                                    <input id="location" name="location" class="form-input w-full px-2 py-1" type="text" value="{{ $item->location }}" />
                                </div>
                                <div>
                                    ...
                                    <select id="packets_id" name="packets_id" class="form-select text-sm py-2 w-full">
                                        <option selected value="{{ $item->packet->id }}">{{ $item->packet->name }}</option>
                                ...
                                <div>
                                    ...
                                    <input id="exp_trial" name="exp_trial" class="form-input w-full px-2 py-1" type="date" value="{{ \Carbon\Carbon::parse($item->exp_trial)->format('Y-m-d') }}"/>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1" for="exp_subscribe">Exp. Berlangganan</label>
                                    <input id="exp_subscribe" name="exp_subscribe" class="form-input w-full px-2 py-1" type="date" value="{{ \Carbon\Carbon::parse($item->exp_subscribe)->format('Y-m-d') }}"/>
                                </div>
                            </div>
                        </div>
                        <!-- Modal footer -->
                        <div class="px-5 py-4 border-t border-slate-200">
                            <div class="flex flex-wrap justify-end space-x-2">
                                <a href="{{ route('member.index') }}" class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600">
                                    Batal
                                </a>
