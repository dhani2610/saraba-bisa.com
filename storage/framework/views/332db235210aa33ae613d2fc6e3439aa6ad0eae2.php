...
>
            ...
            <div class="flex items-center">
                ...
                <div class="flex -space-x-3 -ml-px">
                    <a class="block" href="#0">
                        <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/user-32-01.jpg')); ?>" width="32" height="32" alt="User 01" />
                    </a>
                    <a class="block" href="#0">
    ...
    <div class="grow px-4 sm:px-6 md:px-5 py-6">
        ...
        <div class="flex items-start mb-4 last:mb-0">
            <img class="rounded-full mr-4" src="<?php echo e(asset('images/user-40-11.jpg')); ?>" width="40" height="40" alt="User 01" />
            <div>
        ...
        <!-- Chat msg -->
        <div class="flex items-start mb-4 last:mb-0">
            <img class="rounded-full mr-4" src="<?php echo e(asset('images/user-40-12.jpg')); ?>" width="40" height="40" alt="User 02" />
            <div>
        ...
        <div class="flex items-start mb-4 last:mb-0">
            ...
            <div>
                <div class="flex items-center">
                    <img class="rounded-lg shadow-md mb-1" src="<?php echo e(asset('images/chat-image.jpg')); ?>" width="240" height="180" alt="Chat image" />
...
</div><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/messages/messages-body.blade.php ENDPATH**/ ?>