...
<?php $component->withAttributes([]); ?>
  ...
  <main class="grow">
    ...
    <section class="relative hidden">
      ...
      <div
        class="absolute left-1/2 transform -translate-x-1/2 bottom-0 mb-20 pointer-events-none"
        aria-hidden="true"
      >
        <svg
          width="1360"
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="py-12 md:py-20">
          ...
          <!-- Items -->
          <div
            class="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-5"
          >
            <!-- Item -->
            <div
              class="flex items-center justify-center py-2 col-span-2 md:col-auto"
            >
              <svg
            ...
            <!-- Item -->
            <div
              class="flex items-center justify-center py-2 col-span-2 md:col-auto col-start-2 col-end-4"
            >
              <svg
                class="max-w-full fill-current text-gray-400"
                width="109"
          ...
          <div class="max-w-3xl mx-auto">
            ...
            >
              <!-- Testimonials -->
              <div
                class="relative flex items-start border-2 border-gray-200 rounded bg-white z-10"
                x-ref="testimonials"
              >
                ...
                <template x-for="(item, index) in items" :key="index">
                  ...
                  >
                    ...
                    ></blockquote>
                    <cite
                      class="block font-bold text-lg not-italic mb-1"
                      x-text="item.name"
                    ></cite>
                    <div class="text-gray-600">
...
<?php endif; ?><?php /**PATH C:\laragon\www\saraba-bisa\resources\views/pages/pricing.blade.php ENDPATH**/ ?>