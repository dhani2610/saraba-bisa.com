                    ...
                    <div class="w-full flex items-center justify-between">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button
                                ...
                                :aria-expanded="open"
                            >
                                <img class="w-8 h-8 rounded-full mr-2" src="<?php echo e(asset('images/user-avatar-32.png')); ?>" width="32" height="32" alt="Group 01" />
                                <div class="truncate">
                                ...
                                <ul>
                                        ...
                                        <a class="font-medium text-sm text-slate-600 hover:text-slate-800 block py-1.5 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">
                                            <div class="flex items-center justify-between">
                                                <div class="grow flex items-center truncate">
                                                    <img class="w-7 h-7 rounded-full mr-2" src="<?php echo e(asset('images/channel-01.png')); ?>" width="28" height="28" alt="Channel 01" />
                                    ...
                                    <li>
                                        <a class="font-medium text-sm text-slate-600 hover:text-slate-800 block py-1.5 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">
                                            <div class="flex items-center justify-between">
                                                <div class="grow flex items-center truncate">
                                                    <img class="w-7 h-7 rounded-full mr-2" src="<?php echo e(asset('images/channel-02.png')); ?>" width="28" height="28" alt="Channel 02" />
                                    ...
                                    <li>
                                        <a class="font-medium text-sm text-slate-600 hover:text-slate-800 block py-1.5 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">
                                            <div class="flex items-center justify-between">
                                                <div class="grow flex items-center truncate">
                                                    <img class="w-7 h-7 rounded-full mr-2" src="<?php echo e(asset('images/channel-03.png')); ?>" width="28" height="28" alt="Channel 03" />
                    ...
                    <ul class="mb-6">
                        <li class="-mx-2">
                            <button class="flex items-center justify-between w-full p-2 rounded bg-indigo-100" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                <div class="flex items-center truncate">
                                    <img class="w-8 h-8 rounded-full mr-2" src="<?php echo e(asset('images/user-32-01.jpg')); ?>" width="32" height="32" alt="User 01" />
                                    <div class="truncate">
                        ...
                        <li class="-mx-2">
                            <button class="flex items-center justify-between w-full p-2 rounded" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                <div class="flex items-center truncate">
                                    <img class="w-8 h-8 rounded-full mr-2" src="<?php echo e(asset('images/user-32-02.jpg')); ?>" width="32" height="32" alt="User 02" />
                                    <div class="truncate">
                        ...
                        <li class="-mx-2">
                            <button class="flex items-center justify-between w-full p-2 rounded" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                <div class="flex items-center truncate">
                                    <img class="w-8 h-8 rounded-full mr-2" src="<?php echo e(asset('images/user-32-03.jpg')); ?>" width="32" height="32" alt="User 03" />
                                    <div class="truncate">
                                        <span class="text-sm font-medium text-slate-800">Jerzy Wierzy</span>
                                    </div>
                                </div>
                                <div class="flex items-center ml-2">
                                    <img class="w-5 h-5 rounded-full shrink-0" src="<?php echo e(asset('images/user-32-03.jpg')); ?>" width="20" height="20" alt="User 03" />
                                </div>
                            </button>
                        </li>
                        <li class="-mx-2">
                            <button class="flex items-center justify-between w-full p-2 rounded" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                <div class="flex items-center truncate">
                                    <img class="w-8 h-8 rounded-full mr-2" src="<?php echo e(asset('images/user-32-04.jpg')); ?>" width="32" height="32" alt="User 04" />
                                    <div class="truncate">
                        ...
                        <li class="-mx-2">
                            <button class="flex items-center justify-between w-full p-2 rounded" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                <div class="flex items-center truncate">
                                    <img class="w-8 h-8 rounded-full mr-2" src="<?php echo e(asset('images/user-32-05.jpg')); ?>" width="32" height="32" alt="User 05" />
                                    <div class="truncate">
                        ...
                        <li class="-mx-2">
                            <button class="flex items-center justify-between w-full p-2 rounded" @click="msgSidebarOpen = false; $refs.contentarea.scrollTop = 99999999;">
                                <div class="flex items-center truncate">
                                    <img class="w-8 h-8 rounded-full mr-2" src="<?php echo e(asset('images/user-32-06.jpg')); ?>" width="32" height="32" alt="User 06" />
                                    <div class="truncate">
...
</div><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/messages/messages-sidebar.blade.php ENDPATH**/ ?>