            ...
            <header class="bg-white border-b border-slate-200">
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between h-16 -mb-px">
                        ...
                        <a class="block rounded-full bg-slate-100 text-slate-500 hover:text-slate-600" href="<?php echo e(route('cart')); ?>">
            ...
            <main>
                ...
                <div class="relative pt-8">
                    <div class="absolute inset-0 bg-slate-800 overflow-hidden" aria-hidden="true">
                        <img class="object-cover h-full w-full filter blur opacity-10" src="<?php echo e(asset('images/pay-bg.jpg')); ?>" width="460" height="180" alt="Pay background" />
                    </div>
                    <div class="relative px-4 sm:px-6 lg:px-8 max-w-lg mx-auto">
                        <img class="rounded-t shadow-lg" src="<?php echo e(asset('images/pay-bg.jpg')); ?>" width="460" height="180" alt="Pay background" />
                    </div>
                </div>
                ...
                <div class="relative px-4 sm:px-6 lg:px-8 pb-8 max-w-lg mx-auto" x-data="{ card: true }">
                    <div class="bg-white px-8 pb-6 rounded-b shadow-lg">
                        ...
                        <div class="text-center mb-6">
                            <div class="mb-2">
                                <img class="-mt-8 inline-flex rounded-full" src="<?php echo e(asset('images/user-64-13.jpg')); ?>" width="64" height="64" alt="User" />
                            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/pages/ecommerce/pay.blade.php ENDPATH**/ ?>