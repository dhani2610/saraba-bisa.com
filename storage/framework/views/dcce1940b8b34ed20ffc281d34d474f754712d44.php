    ...
    <div class="flex flex-col h-full">
                ...
                <header>                
                    <div class="flex mb-2">
                        <a class="relative inline-flex items-start mr-5" href="#0">
                            ...
                            <img class="rounded-full" src="<?php echo e(asset('images/' . $member->image)); ?>" width="64" height="64" alt="<?php echo e($member->name); ?>" />
                        </a>
                        <div class="mt-1 pr-1">
                            <a class="inline-flex text-slate-800 hover:text-slate-900" href="#0">
                                <h2 class="text-xl leading-snug justify-center font-semibold"><?php echo e($member->name); ?></h2>
                            </a>
                            <div class="flex items-center"><span class="text-sm font-medium text-slate-400 -mt-0.5 mr-1">-&gt;</span> <span><?php echo e($member->location); ?></span></div>
                        </div>
                    </div>
                </header>
                <!-- Menu button -->
        ...
        <div class="border-t border-slate-200">
            <div class="flex divide-x divide-slate-200r">
                <a class="block flex-1 text-center text-sm text-indigo-500 hover:text-indigo-600 font-medium px-3 py-4" href="<?php echo e(route('messages')); ?>">
                ...
                <a class="block flex-1 text-center text-sm text-slate-600 hover:text-slate-800 font-medium px-3 py-4 group" href="<?php echo e(route('settings')); ?>">
                    <div class="flex items-center justify-center">
...
</div><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/community/users-tiles-cards.blade.php ENDPATH**/ ?>