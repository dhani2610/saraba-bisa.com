    ...
    <div class="flex flex-col h-full">
        ...
        <div class="grow p-5">
            ...
            <header>                
                ...
                <div class="flex justify-center items-center"><span class="text-sm font-medium text-slate-400 -mt-0.5 mr-1">-&gt;</span> <span><?php echo e($member->location); ?></span></div>
            </header>
            <!-- Bio -->
        ...
        <div class="border-t border-slate-200">
            <a class="block text-center text-sm text-indigo-500 hover:text-indigo-600 font-medium px-3 py-4" href="<?php echo e(route('messages')); ?>">
...
</div><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/community/users-tabs-cards.blade.php ENDPATH**/ ?>