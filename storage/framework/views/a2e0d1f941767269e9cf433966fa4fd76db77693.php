                    ...
                    <ul class="mb-6">
                            ...
                            <button class="w-full p-2 rounded bg-indigo-100" @click="profileSidebarOpen = false">
                                <div class="flex items-center">
                                    <div class="relative mr-2">
                                        <img class="w-8 h-8 rounded-full" src="<?php echo e(asset('images/user-32-08.jpg')); ?>" width="32" height="32" alt="User 08" />
                                    </div>
                                    <div class="truncate">
                        ...
                        <li class="-mx-2">
                            <button class="w-full p-2 rounded" @click="profileSidebarOpen = false">
                                <div class="flex items-center truncate">
                                    <div class="relative mr-2">
                                        <img class="w-8 h-8 rounded-full" src="<?php echo e(asset('images/user-32-06.jpg')); ?>" width="32" height="32" alt="User 06" />
                                    </div>
                                    <div class="truncate">
                        ...
                        <li class="-mx-2">
                            <button class="w-full p-2 rounded" @click="profileSidebarOpen = false">
                                <div class="flex items-center truncate">
                                    <div class="relative mr-2">
                                        <img class="w-8 h-8 rounded-full" src="<?php echo e(asset('images/user-32-03.jpg')); ?>" width="32" height="32" alt="User 03" />
                                    </div>
                                    <div class="truncate">
...
</div><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/community/profile-sidebar.blade.php ENDPATH**/ ?>