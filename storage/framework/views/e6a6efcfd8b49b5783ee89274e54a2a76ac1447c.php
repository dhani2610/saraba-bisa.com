                ...
                <div class="py-8 px-4 lg:px-8 2xl:px-12">
                    <div class="max-w-sm mx-auto lg:max-w-none">
                        ...
                        <div class="space-y-6">
                                ...
                                <ul>
                                    ...
                                    <li class="flex items-center py-3 border-b border-slate-200">
                                        <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                                            <img class="w-16 xl:w-20" src="<?php echo e(asset('images/related-product-01.jpg')); ?>" width="200" height="142" alt="Product 01" />
                                        </a>
                                        <div class="grow">
                                            <a href="#0">
                                    ...
                                    <li class="flex items-center py-3 border-b border-slate-200">
                                        <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                                            <img class="w-16 xl:w-20" src="<?php echo e(asset('images/related-product-02.jpg')); ?>" width="200" height="142" alt="Product 02" />
                                        </a>
                                        <div class="grow">
                                            <a href="#0">
                                    ...
                                    <li class="flex items-center py-3 border-b border-slate-200">
                                        <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                                            <img class="w-16 xl:w-20" src="<?php echo e(asset('images/related-product-03.jpg')); ?>" width="200" height="142" alt="Product 03" />
                                        </a>
                                        <div class="grow">
                                            <a href="#0">
                            ...
                            <div class="mt-6">
                                <div class="mb-4">
                                    <a href="<?php echo e(route('pay')); ?>" class="btn w-full bg-indigo-500 hover:bg-indigo-600 text-white">View Your Order</a>
                                </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/pages/ecommerce/cart-3.blade.php ENDPATH**/ ?>