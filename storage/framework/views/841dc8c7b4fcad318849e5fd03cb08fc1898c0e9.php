...
<div class="bg-white shadow-md rounded border border-slate-200 p-5">
    ...
    <header class="flex justify-between items-start space-x-3 mb-3">
        ...
        <div class="flex items-start space-x-3">
            <img class="rounded-full shrink-0" src="<?php echo e(asset('images/user-40-03.jpg')); ?>" width="40" height="40" alt="User 03" />
            <div>
...
<div class="bg-white shadow-md rounded border border-slate-200 p-5">
    ...
    <header class="flex justify-between items-start space-x-3 mb-3">
        <!-- User -->
        <div class="flex items-start space-x-3">
            <img class="rounded-full shrink-0" src="<?php echo e(asset('images/user-40-06.jpg')); ?>" width="40" height="40" alt="User 06" />
            <div>
                <div class="leading-tight">
    ...
    <div class="text-sm text-slate-800 space-y-2 mb-5">
        ...
        <div class="relative !my-4">
            <img class="block w-full" src="<?php echo e(asset('images/feed-image-01.jpg')); ?>" width="590" height="332" alt="Feed 01" />
...
<div class="bg-white shadow-md rounded border border-slate-200 p-5">
    ...
    <header class="flex justify-between items-start space-x-3 mb-3">
        <!-- User -->
        <div class="flex items-start space-x-3">
            <img class="rounded-full shrink-0" src="<?php echo e(asset('images/user-40-04.jpg')); ?>" width="40" height="40" alt="User 04" />
            <div>
                <div class="leading-tight">
    ...
    <div class="mt-5 pt-3 border-t border-slate-200">
        <ul class="space-y-2 mb-3">
            ...
            <li class="p-3 bg-slate-50 rounded">
                <div class="flex items-start space-x-3">
                    <img class="rounded-full shrink-0" src="<?php echo e(asset('images/user-32-04.jpg')); ?>" width="32" height="32" alt="User 04" />
                    <div>
            ...
            <li class="p-3 bg-slate-50 rounded">
                <div class="flex items-start space-x-3">
                    <img class="rounded-full shrink-0" src="<?php echo e(asset('images/user-32-05.jpg')); ?>" width="32" height="32" alt="User 05" />
                    <div>
                        <div class="text-xs text-slate-500">
        ...
        <div class="flex items-center space-x-3 mt-3">
            <img class="rounded-full shrink-0" src="<?php echo e(asset('images/user-40-02.jpg')); ?>" width="32" height="32" alt="User 02" />
            <div class="grow">
...
<div class="bg-white shadow-md rounded border border-slate-200 p-5">
    ...
    <header class="flex justify-between items-start space-x-3 mb-3">
        <!-- User -->
        <div class="flex items-start space-x-3">
            <img class="rounded-full shrink-0" src="<?php echo e(asset('images/user-40-08.jpg')); ?>" width="40" height="40" alt="User 08" />
            <div>
                <div class="leading-tight">
    ...
    <div class="text-sm text-slate-800 space-y-2 mb-5">
        ...
        <div class="relative flex items-center justify-center !my-4">
            <img class="block w-full" src="<?php echo e(asset('images/feed-image-02.jpg')); ?>" width="590" height="332" alt="Feed 01" />
...
</div>  <?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/community/feed-posts.blade.php ENDPATH**/ ?>