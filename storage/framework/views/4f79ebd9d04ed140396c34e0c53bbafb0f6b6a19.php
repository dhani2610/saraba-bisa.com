    ...
    <div class="flex flex-col h-full p-5">
        <header>
            <div class="flex items-center justify-between">
                ...
                <?php elseif($campaign->category === '2'): ?>
                ...
                <?php elseif($campaign->category === '3'): ?>
                ...
                <?php elseif($campaign->category === '4'): ?>
                ...
                <div class="flex shrink-0 -space-x-3 -ml-px">
                    <?php $__currentLoopData = $campaign->members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                        
                        <a class="block" href="<?php echo e($member->link); ?>">
                            <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/' . $member->image)); ?>" width="28" height="28" alt="<?php echo e($member->name); ?>" />
                        </a>
        ...
        <div class="grow mt-2">
            <a class="inline-flex text-slate-800 hover:text-slate-900 mb-1" href="#0">
                <h2 class="text-xl leading-snug font-semibold"><?php echo e($campaign->title); ?></h2>
            </a>
            <div class="text-sm"><?php echo e($campaign->content); ?></div>
        </div>
        <footer class="mt-5">
            <div class="text-sm font-medium text-slate-500 mb-2"><?php echo e(\Carbon\Carbon::parse($campaign->start_date)->format('M j')); ?> <span class="text-slate-400">-&gt;</span> <?php echo e(\Carbon\Carbon::parse($campaign->end_date)->format('M j')); ?></div>
            <div class="flex justify-between items-center">
                <div>
                    <div class="text-xs inline-flex font-medium rounded-full text-center px-2.5 py-1 <?php echo e($status_color); ?>"><?php echo e($campaign->type); ?></div>
                </div>
                <div>
...
</div><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/campaigns/campaigns-card.blade.php ENDPATH**/ ?>