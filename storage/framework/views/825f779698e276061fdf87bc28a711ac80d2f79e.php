        ...
        <main class="bg-white">
            ...
            <div class="relative flex">
                ...
                <div class="hidden md:block absolute top-0 bottom-0 right-0 md:w-1/2" aria-hidden="true">
                    <img class="object-cover object-center w-full h-full" src="<?php echo e(asset('images/auth-image.jpg')); ?>" width="760" height="1024" alt="Authentication image" />
...
<?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/layouts/authentication.blade.php ENDPATH**/ ?>