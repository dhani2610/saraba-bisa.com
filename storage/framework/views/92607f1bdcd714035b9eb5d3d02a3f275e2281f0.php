<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-slate-200">
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            <!-- Icon -->
            <img src="<?php echo e(asset('images/icon-01.svg')); ?>" width="32" height="32" alt="Icon 01" />
            <!-- Menu button -->
        ...
        <div class="flex items-start">
            <div class="text-3xl font-bold text-slate-800 mr-2">$<?php echo e(number_format($dataFeed->sumDataSet(1, 1), 0)); ?></div>
...
<?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/dashboard/dashboard-card-01.blade.php ENDPATH**/ ?>