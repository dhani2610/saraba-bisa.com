...
<?php $component->withAttributes([]); ?>
    ...
    <div class="h-56 bg-slate-200">
        <img class="object-cover h-full w-full" src="<?php echo e(asset('images/company-bg.jpg')); ?>" width="2560" height="440" alt="Company background" />
    </div>
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="-mt-12 mb-2">
                    <div class="inline-flex -ml-1 -mt-1 sm:mb-0">
                        <img class="rounded-full border-4 border-white" src="<?php echo e(asset('images/company-icon-01.svg')); ?>" width="104" height="104" alt="Avatar" />
                    </div>
                </div>
                            ...
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    <div class="w-9 h-9 shrink-0 mt-1">
                                        <img class="w-9 h-9 rounded-full" src="<?php echo e(asset('images/company-icon-01.svg')); ?>" width="36" height="36" alt="Company 01" />
                                    </div>
                                    <div>
                                        <a class="inline-flex font-semibold text-slate-800" href="<?php echo e(route('job-post')); ?>">Senior Software Engineer Backend</a>
                        ...
                        <div class="bg-white shadow-lg rounded-sm border border-slate-200 px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    ...
                                    <div>
                                        <a class="inline-flex font-semibold text-slate-800" href="<?php echo e(route('job-post')); ?>">React.js Software Developer</a>
                                        <div class="text-sm">Full-time / Remote / London, UK</div>
                                    </div>
                                </div>
                                <!-- Right side -->
                        ...
                        <div class="bg-white shadow-lg rounded-sm border border-slate-200 px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    ...
                                    <div>
                                        <a class="inline-flex font-semibold text-slate-800" href="<?php echo e(route('job-post')); ?>">Senior Full Stack Rails Developer</a>
                                        <div class="text-sm">Full-time / Remote / London, UK</div>
                                    </div>
                                </div>
                                <!-- Right side -->
                        ...
                        <div class="bg-white shadow-lg rounded-sm border border-slate-200 px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    ...
                                    <div>
                                        <a class="inline-flex font-semibold text-slate-800" href="<?php echo e(route('job-post')); ?>">Senior Web App Designer</a>
                                        <div class="text-sm">Full-time / Remote / London, UK</div>
                                    </div>
                                </div>
                                <!-- Right side -->
                        ...
                        <div class="bg-white shadow-lg rounded-sm border border-slate-200 px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    ...
                                    <div>
                                        <a class="inline-flex font-semibold text-slate-800" href="<?php echo e(route('job-post')); ?>">Senior UI/UX Designer</a>
                                        <div class="text-sm">Full-time / Remote / London, UK</div>
                                    </div>
                                </div>
                                <!-- Right side -->
                        ...
                        <div class="bg-white shadow-lg rounded-sm border border-slate-200 px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    ...
                                    <div>
                                        <a class="inline-flex font-semibold text-slate-800" href="<?php echo e(route('job-post')); ?>">Financial Planning & Analysis Manager</a>
                                        <div class="text-sm">Full-time / Remote / London, UK</div>
                                    </div>
                                </div>
                                <!-- Right side -->
                        ...
                        <div class="bg-white shadow-lg rounded-sm border border-slate-200 px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    ...
                                    <div>
                                        <a class="inline-flex font-semibold text-slate-800" href="<?php echo e(route('job-post')); ?>">Senior Consultant Growth Strategy</a>
                                        <div class="text-sm">Full-time / Remote / London, UK</div>
                                    </div>
                                </div>
                                <!-- Right side -->
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/pages/job/company-profile.blade.php ENDPATH**/ ?>