                ...
                <tbody class="text-sm divide-y divide-slate-100">
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex shrink-0 -space-x-3 -ml-px">
                                <a class="block" href="#0">
                                    <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/user-28-01.jpg')); ?>" width="28" height="28" alt="User 01" />
                                </a>
                                <a class="block" href="#0">
                    ...
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex shrink-0 -space-x-3 -ml-px">
                                ...
                                <a class="block" href="#0">
                                    <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/user-28-04.jpg')); ?>" width="28" height="28" alt="User 04" />
                                </a>
                                <a class="block" href="#0">
                    ...
                    <tr>
                        ...
                        <td class="p-2 whitespace-nowrap">
                            <div class="flex shrink-0 -space-x-3 -ml-px">
                                <a class="block" href="#0">
                                    <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/user-28-09.jpg')); ?>" width="28" height="28" alt="User 09" />
                                </a>
                                <a class="block" href="#0">
                                    <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/user-28-01.jpg')); ?>" width="28" height="28" alt="User 01" />
                                </a>
...
</div><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/analytics/analytics-card-11.blade.php ENDPATH**/ ?>