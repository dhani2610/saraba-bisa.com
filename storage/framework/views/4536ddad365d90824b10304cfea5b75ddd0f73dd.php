        ...
        <div class="bg-white shadow-lg rounded-sm border border-slate-200 px-6 divide-y divide-slate-200">
            ...
            <div class="py-6" x-data="{ open: false }">
                ...
                <header class="flex items-start">
                    <!-- Avatar -->
                    <img class="rounded-full shrink-0 mr-3" src="<?php echo e(asset('images/user-40-11.jpg')); ?>" width="40" height="40" alt="User 11" />
                    <!-- Meta -->
                    <div class="grow">
            ...
            <div class="py-6" x-data="{ open: false }">
                ...
                <header class="flex items-start">
                    <!-- Avatar -->
                    <img class="rounded-full shrink-0 mr-3" src="<?php echo e(asset('images/user-avatar-80.png')); ?>" width="40" height="40" alt="User 11" />
                    <!-- Meta -->
                    <div class="grow">
                        <div class="sm:flex items-start justify-between mb-0.5">
                            <!-- Message author -->
            ...
            <div class="py-6" x-data="{ open: true }">
                ...
                <div class="text-sm text-slate-800 mt-4 space-y-2" x-show="open" x-cloak>
                    ...
                    <p>
                        <img src="<?php echo e(asset('images/inbox-image.jpg')); ?>" width="320" height="190" alt="Inbox image" />
                    </p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                    <p>Cheers,</p>
                    <p class="font-medium">Dominik Lamakani</p>
...
</div><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/inbox/inbox-body.blade.php ENDPATH**/ ?>