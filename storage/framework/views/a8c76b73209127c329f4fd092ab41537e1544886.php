    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
                ...
                <div class="space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0 mb-6">
                    ...
                    <div class="flex items-center sm:mr-4">
                        <a class="block mr-2 shrink-0" href="#0">
                            <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/user-32-07.jpg')); ?>" width="32" height="32" alt="User 04" />
                        </a>
                ...
                <!-- Image -->
                <figure class="mb-6">
                    <img class="w-full rounded-sm" src="<?php echo e(asset('images/product-image.jpg')); ?>" width="640" height="360" alt="Product" />
                </figure>
                    ...
                    <ul class="space-y-5 my-6">
                        ...
                        <li>
                            <div class="flex items-center mb-2">
                                <img class="w-8 h-8 rounded-full mr-3" src="<?php echo e(asset('images/user-32-07.jpg')); ?>" width="32" height="32" alt="User 07" />
                                <div>
                        ...
                        <li>
                            <div class="flex items-center mb-2">
                                <img class="w-8 h-8 rounded-full mr-3" src="<?php echo e(asset('images/user-32-05.jpg')); ?>" width="32" height="32" alt="User 05" />
                                <div>
                        ...
                        <li>
                            <div class="flex items-center mb-2">
                                <img class="w-8 h-8 rounded-full mr-3" src="<?php echo e(asset('images/user-32-03.jpg')); ?>" width="32" height="32" alt="User 03" />
                                <div>
                        ...
                        <li>
                            <div class="flex items-center mb-2">
                                <img class="w-8 h-8 rounded-full mr-3" src="<?php echo e(asset('images/user-32-04.jpg')); ?>" width="32" height="32" alt="User 04" />
                                <div>
                    ...
                    <ul class="space-y-8 sm:space-y-5 my-6">
                        ...
                        <li class="sm:flex items-center">
                            <a class="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto shrink-0" href="#0">
                                <img class="rounded-sm" src="<?php echo e(asset('images/related-product-01.jpg')); ?>" width="200" height="142" alt="Product 01" />
                            </a>
                            <div class="grow">
                                <a href="#0">
                        ...
                        <li class="sm:flex items-center">
                            <a class="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto shrink-0" href="#0">
                                <img class="rounded-sm" src="<?php echo e(asset('images/related-product-02.jpg')); ?>" width="200" height="142" alt="Product 02" />
                            </a>
                            <div class="grow">
                                <a href="#0">
                        ...
                        <li class="sm:flex items-center">
                            <a class="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto shrink-0" href="#0">
                                <img class="rounded-sm" src="<?php echo e(asset('images/related-product-03.jpg')); ?>" width="200" height="142" alt="Product 03" />
                            </a>
                            <div class="grow">
                                <a href="#0">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/pages/ecommerce/product.blade.php ENDPATH**/ ?>