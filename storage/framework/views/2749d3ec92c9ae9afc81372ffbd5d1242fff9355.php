...
>
    ...
    <div class="relative h-56 bg-slate-200">
        <img class="object-cover h-full w-full" src="<?php echo e(asset('images/profile-bg.jpg')); ?>" width="979" height="220" alt="Profile background" />
        <!-- Close button -->
        <button
        ...
        <div class="-mt-16 mb-6 sm:mb-3">
            ...
            <div class="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
                ...
                <div class="inline-flex -ml-1 -mt-1 mb-4 sm:mb-0">
                    <img class="rounded-full border-4 border-white" src="<?php echo e(asset('images/user-128-01.jpg')); ?>" width="128" height="128" alt="Avatar" />
                </div>
                ...
                <div>
                    ...
                    <div class="grid xl:grid-cols-2 gap-4">
                        ...
                        <div class="bg-white p-4 border border-slate-200 rounded-sm shadow-sm">
                            ...
                            <div class="grow flex items-center truncate mb-2">
                                <div class="w-8 h-8 shrink-0 flex items-center justify-center bg-slate-700 rounded-full mr-2">
                                    <img class="ml-1" src="<?php echo e(asset('images/icon-03.svg')); ?>" width="14" height="14" alt="Icon 03" />
                                </div>
                                <div class="truncate">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex -space-x-3 -ml-0.5">
                                    <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/avatar-02.jpg')); ?>" width="24" height="24" alt="Avatar" />
                                    <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/avatar-03.jpg')); ?>" width="24" height="24" alt="Avatar" />
                                    <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/avatar-04.jpg')); ?>" width="24" height="24" alt="Avatar" />
                                    <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/avatar-05.jpg')); ?>" width="24" height="24" alt="Avatar" />
                                </div>
                                <!-- Link -->
                                <div>
                        ...
                        <div class="bg-white p-4 border border-slate-200 rounded-sm shadow-sm">
                            ...
                            <div class="grow flex items-center truncate mb-2">
                                <div class="w-8 h-8 shrink-0 flex items-center justify-center bg-slate-700 rounded-full mr-2">
                                    <img class="ml-1" src="<?php echo e(asset('images/icon-02.svg')); ?>" width="14" height="14" alt="Icon 02" />
                                </div>
                                <div class="truncate">
                            ...
                            <div class="flex justify-between items-center">
                                <!-- Avatars group -->
                                <div class="flex -space-x-3 -ml-0.5">
                                    <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/avatar-06.jpg')); ?>" width="24" height="24" alt="Avatar" />
                                    <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/avatar-03.jpg')); ?>" width="24" height="24" alt="Avatar" />
                                    <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/avatar-01.jpg')); ?>" width="24" height="24" alt="Avatar" />
                                </div>
                                <!-- Link -->
                                <div>
                                    <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">View -&gt;</a>
...
</div><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/community/profile-body.blade.php ENDPATH**/ ?>