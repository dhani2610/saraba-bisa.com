            ...
            <div class="px-5 py-4">
                ...
                <div class="mt-4">
                    ...
                    <ul class="mb-6">
                        ...
                        <li class="-mx-2">
                            <button class="flex w-full p-2 rounded text-left" @click="inboxSidebarOpen = false">
                                <img class="w-8 h-8 rounded-full mr-2" src="<?php echo e(asset('images/user-32-06.jpg')); ?>" width="32" height="32" alt="User 05" />
                                <div class="grow truncate">
                                    <div class="flex items-center justify-between mb-1.5">
                                        <div class="truncate">
                        ...
                        <li class="-mx-2">
                            <button class="flex w-full p-2 rounded text-left" @click="inboxSidebarOpen = false">
                                <img class="w-8 h-8 rounded-full mr-2" src="<?php echo e(asset('images/user-32-04.jpg')); ?>" width="32" height="32" alt="User 05" />
                                <div class="grow truncate">
                                    <div class="flex items-center justify-between mb-1.5">
                                        <div class="truncate">
                        ...
                        <li class="-mx-2">
                            <button class="flex w-full p-2 rounded text-left" @click="inboxSidebarOpen = false">
                                <img class="w-8 h-8 rounded-full mr-2" src="<?php echo e(asset('images/user-32-02.jpg')); ?>" width="32" height="32" alt="User 05" />
                                <div class="grow truncate">
                                    <div class="flex items-center justify-between mb-1.5">
                                        <div class="truncate">
...
</div><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/inbox/inbox-sidebar.blade.php ENDPATH**/ ?>