...
<?php $component->withAttributes([]); ?>
          ...
          <div class="carousel swiper-container">
            <div class="swiper-wrapper">
              ...
              >
                <img
                  class="mb-3"
                  src="<?php echo e(asset('images/fitur-11.svg')); ?>"
                  width="56"
                  height="56"
                  alt="Icon 04"
                />
  ...
  <script src="<?php echo e(asset('js/sticky.min.js')); ?>"></script>
...
<?php endif; ?><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/pages/home.blade.php ENDPATH**/ ?>