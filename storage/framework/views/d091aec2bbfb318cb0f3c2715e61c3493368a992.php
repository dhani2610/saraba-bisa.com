    ...
    <div class="p-6 space-y-6">
        ...
        <section>
            <div class="flex items-center">
                <div class="mr-4">
                    <img class="w-20 h-20 rounded-full" src="<?php echo e(asset('images/user-avatar-80.png')); ?>" width="80" height="80" alt="User upload" />
                </div>
...
</div><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/settings/account-panel.blade.php ENDPATH**/ ?>