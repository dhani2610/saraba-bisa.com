                ...
                <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-4">
                    ...
                    <div class="flex shrink-0 -space-x-3 -ml-px">
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-slate-100 box-content" src="<?php echo e(asset('images/user-32-08.jpg')); ?>"" width="32" height="32" alt="User 08" />
                        </a>
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-slate-100 box-content" src="<?php echo e(asset('images/user-32-07.jpg')); ?>"" width="32" height="32" alt="User 07" />
                        </a>
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-slate-100 box-content" src="<?php echo e(asset('images/user-32-05.jpg')); ?>"" width="32" height="32" alt="User 05" />
                        </a>
                        ...
                        <div class="bg-white shadow-lg rounded-sm border border-slate-200 p-4" draggable="true">
                            <div class="sm:flex sm:justify-between sm:items-start">
                                ...
                                <div class="flex items-center justify-end space-x-3">
                                    ...
                                    <div class="flex shrink-0 -space-x-3 -ml-px">
                                        <a class="block" href="#0">
                                            <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/user-32-07.jpg')); ?>"" width="24" height="24" alt="User 07" />
                                        </a>
                                        <a class="block" href="#0">
                                            <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/user-32-05.jpg')); ?>"" width="24" height="24" alt="User 05" />
                                        </a>
                                    </div>
                                    <!-- Like button -->
                        ...
                        <div class="bg-white shadow-lg rounded-sm border border-slate-200 p-4" draggable="true">
                            <div class="sm:flex sm:justify-between sm:items-start">
                                ...
                                <div class="flex items-center justify-end space-x-3">
                                    ...
                                    <div class="flex shrink-0 -space-x-3 -ml-px">
                                        <a class="block" href="#0">
                                            <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/user-32-08.jpg')); ?>"" width="24" height="24" alt="User 08" />
                                        </a>
                                        <a class="block" href="#0">
                                            <img class="rounded-full border-2 border-white box-content" src="<?php echo e(asset('images/user-32-07.jpg')); ?>"" width="24" height="24" alt="User 07" />
                                        </a>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/pages/tasks/tasks-list.blade.php ENDPATH**/ ?>