                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap md:w-1/2">
                                <div class="flex items-center">
                                    <div class="w-9 h-9 shrink-0 mr-2 sm:mr-3">
                                        <img class="w-9 h-9 rounded-full" src="<?php echo e(asset('images/' . $transaction->image)); ?>" width="36" height="36" alt="<?php echo e($transaction->name); ?>" />
                                    </div>
                                    <div class="font-medium text-slate-800"><?php echo e($transaction->name); ?></div>
                                </div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="text-left"><?php echo e(\Carbon\Carbon::parse($transaction->created_at)->format('d/m/Y')); ?></div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="text-left">
                                    <div class="text-xs inline-flex font-medium rounded-full text-center px-2.5 py-1 <?php echo e($status_color); ?>"><?php echo e($transaction->status); ?></div>
                                </div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="text-right font-medium <?php echo e($amount_color); ?>"><?php echo e($transaction->amount); ?></div>
                            </td>
                        </tr>
...
</script><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/finance/transactions-table.blade.php ENDPATH**/ ?>