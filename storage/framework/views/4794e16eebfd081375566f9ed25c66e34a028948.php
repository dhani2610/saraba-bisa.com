...
<?php $component->withAttributes([]); ?>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
                <div class="mb-6">
                    <a class="btn-sm px-3 bg-white border-slate-200 hover:border-slate-300 text-slate-600" href="<?php echo e(route('job-listing')); ?>">
                ...
                <div class="bg-white p-5 shadow-lg rounded-sm border border-slate-200 mb-6 lg:hidden">
                    <div class="text-center mb-6">
                        <div class="inline-flex mb-3">
                            <img class="w-16 h-16 rounded-full" src="<?php echo e(asset('images/company-icon-01.svg')); ?>" width="64" height="64" alt="Company 01" />
                        </div>
                    ...
                    <div class="space-y-2 mt-6">
                            ...
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    <div class="w-9 h-9 shrink-0 mt-1">
                                        <img class="w-9 h-9 rounded-full" src="<?php echo e(asset('images/company-icon-03.svg')); ?>" width="36" height="36" alt="Company 03" />
                                    </div>
                                    <div>
                        ...
                        <div class="bg-white shadow-lg rounded-sm border border-slate-200 px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    <div class="w-9 h-9 shrink-0 mt-1">
                                        <img class="w-9 h-9 rounded-full" src="<?php echo e(asset('images/company-icon-07.svg')); ?>" width="36" height="36" alt="Company 07" />
                                    </div>
                                    <div>
                        ...
                        <div class="bg-white shadow-lg rounded-sm border border-slate-200 px-5 py-4">
                            <div class="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
                                ...
                                <div class="flex items-start space-x-3 md:space-x-4">
                                    <div class="w-9 h-9 shrink-0 mt-1">
                                        <img class="w-9 h-9 rounded-full" src="<?php echo e(asset('images/company-icon-08.svg')); ?>" width="36" height="36" alt="Company 08" />
                                    </div>
                                    <div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/pages/job/job-post.blade.php ENDPATH**/ ?>