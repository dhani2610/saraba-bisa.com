<div class="bg-white shadow-lg rounded-sm border border-slate-200 mb-8">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-slate-800">All Orders <span class="text-slate-400 font-medium"><?php echo e($count); ?></span></h2>
    </header>
                ...
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tbody class="text-sm" x-data="{ open: false }">
                        ...
                        <tr>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="flex items-center text-slate-800">
                                    <div class="w-10 h-10 shrink-0 flex items-center justify-center bg-slate-100 rounded-full mr-2 sm:mr-3">
                                        <img class="ml-1" src="<?php echo e(asset('images/' . $order->image)); ?>" width="20" height="20" alt="<?php echo e($order->order); ?>" />
                                    </div>
                                    <div class="font-medium text-sky-500"><?php echo e($order->order); ?></div>
                                </div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium text-slate-800"><?php echo e($order->customer); ?></div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="text-left font-medium text-emerald-500"><?php echo e($order->total); ?></div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="text-center"><?php echo e($order->items); ?></div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="text-left"><?php echo e($order->location); ?></div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="flex items-center">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="flex items-center">
                                    <button
                                        ...
                                        :aria-expanded="open"
                                        aria-controls="description-<?php echo e($order->id); ?>"
                                    >
                                        <span class="sr-only">Menu</span>
                        ...
                        -->
                        <tr id="description-<?php echo e($order->id); ?>" role="region" x-show="open" x-cloak>
                            <td colspan="10" class="px-2 first:pl-5 last:pr-5 py-3">
                                <div class="flex items-center bg-slate-50 p-3 -mt-3">
                                    ...
                                    <div class="italic"><?php echo e($order->description); ?></div>
                                </div>
                            </td>
                        </tr>
                    </tbody>
...
</script><?php /**PATH C:\laragon\www\main-saraba-bisa\resources\views/components/ecommerce/orders-table.blade.php ENDPATH**/ ?>